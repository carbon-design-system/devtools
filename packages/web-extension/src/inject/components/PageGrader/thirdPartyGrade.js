...
function northstarCheck(grades = {}) {
  grades.northstar = {
    errorMsg: {
      ...
      msg:
        'Northstar has been replaced by the IBM.com Library, and teams should be migrating away from using it.',
      link: {
...
function jqueryCheck(grades = {}) {
  grades.jquery = {
    errorMsg: {
      title: 'jQuery found',
      msg:
        "jQuery isn't needed anymore, and Carbon has intentionally steared away from being dependent on it.",
      link: {
