...
cloudPal[`.${cloudPalPrefix}--data-table`] = 'DataTable';
...
cloudPal[`.${cloudPalPrefix}--grid-layout`] = 'GridLayout';
cloudPal[`.${cloudPalPrefix}--left-panel-layout`] = 'LeftPanelLayout';
cloudPal[`.${cloudPalPrefix}--titled-section-layout`] = 'TitledSectionLayout';
